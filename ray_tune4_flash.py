...
def trainable_ray(config: dict):
    ...
    cfg.update({
        # nb_features is ignored by the flash model but kept for compatibility
        "nb_features": config.get("nb_features", 0),
...
def main():
    ...
    # ────────────────────────────────────────────────────────
    # EXPANDED: Valid (d_model, heads) combos
    # d_model up to 512, head_dim must be >= 16
    # ────────────────────────────────────────────────────────
    valid_dm_heads = []
    ...
    # ────────────────────────────────────────────────────────
    # EXPANDED search space — unleash full power
    # ────────────────────────────────────────────────────────
    param_space = {
        ...
        "gamma": tune.choice([0.0, 1.0, 2.0]),        # focal loss gamma
