...
#!/usr/bin/env python3
"""
Phase B: Retrain new best Flash config on full data.
"""
from ray_tune4_flash import trainable_ray

best_cfg = {
    # ── Architecture (new best: deeper + more regularized) ──
    "dm_heads": (128, 4),
    "N": 7,
    "dff_mult": 3,
    "dropout": 0.40852753205129416,

    # ── Optimization ──
    "lr": 0.0009973854016532193,
    "tau": 0.3467758499507039,
    "gamma": 0.0,
    "warmup_steps": 2000,
    "batch_size": 4,
    "label_smoothing": 0.058768074598041814,
