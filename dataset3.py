...
class TransformerDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return {
            ...
            "short_long_cross_mask": (lto_input != self.pad_token).unsqueeze(0).unsqueeze(0).repeat_interleave(self.source_rate, dim=-1).repeat(self.num_heads, 1, 1) & causal_mask_rectangular(lto_input.size(0)),
