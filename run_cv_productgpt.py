...
BEST_HP = dict(
    nb_features=16, d_model=128, d_ff=128, N=6, num_heads=4,
    lr=1e-4, weight=2, gamma=1.0,   # keep gamma if your loss uses it
)
...
def main():
    ...
    cols = [
        ...
        "val_all_rev_mae",
        "test_all_hit_rate", "test_all_f1_score", "test_all_auprc",
        "model", "basename"
    ]
