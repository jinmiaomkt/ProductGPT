...
from train4_decision_only_bigbird_aws import train_model
...
def run_one_experiment(params):
    ...
    unique_id = f"ctx_window{ctx_window}_dmodel{d_model}_ff{d_ff}_N{N}_heads{num_heads}_lr{lr}_weight{weight}"
